const hosts_local = {
    ...
    primes_service: "http://localhost:8081",
    ciphers_service: "http://localhost:4006",
    quotation_service: "http://localhost:4004"
};

const hosts_remote = {
   arithmetic_service: "https://arithmetic-service-tanmayee2.onrender.com",
   primes_service: "https://primes-service-tanmayee2.onrender.com",
   ciphers_service: "https://ciphers-service-latest-a2sj.onrender.com",
   quotation_service: "?"
};
